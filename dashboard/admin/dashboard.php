    ...
    <div class="d-flex">
        ...
        <nav id="sidebar" class="sidebar">
            ...
            <ul class="nav flex-column p-3">
                ...
                <li class="nav-item"><a href="../../dashboard/admin/transmgt.php" class="nav-link"><i class="fas fa-language"></i> <span>Translations Management</span></a></li>
        ...
        <div id="main-content" class="main-content flex-grow-1">
            ...
            <header class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div class="d-flex align-items-center">
                    <input type="text" class="form-control search-bar me-3" placeholder="Search users...">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form method="POST" style="display:inline;">
                                            ...
                                            <a href="../../dashboard/admin/translogs.php?id=<?php echo htmlspecialchars($user['id']); ?>" class="btn btn-success btn-sm">View Translation Logs</a>
                ...
                <div class="modal-body">
                    <form id="createUserForm" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control" id="userEmail" name="password" required>
                        </div>
                        <div class="mb-3">
