                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <?php foreach ($translations as $translation): ?> <!-- Use foreach to iterate over results -->
                                <tr>
                                    <td><?php echo htmlspecialchars($translation['id']); ?></td>
                                    <td><?php echo htmlspecialchars($translation['filename']); ?></td>
                                    <td><?php echo htmlspecialchars($translation['source_language']); ?></td>
                                    <td><?php echo htmlspecialchars($translation['target_language']); ?></td>
                                    <td><?php echo htmlspecialchars($translation['status']); ?></td>
                                    <td><?php echo htmlspecialchars($translation['created_at']); ?></td>
                                    <td><?php echo htmlspecialchars($translation['updated_at']); ?></td>
                                    <td>
                                        <a href="edit_translation.php?id=<?php echo htmlspecialchars($translation['id']); ?>">Edit</a>
                                        <a href="../../dashboard/admin/delete_translation.php?id=<?php echo htmlspecialchars($translation['id']); ?>" onclick="return confirm('Are you sure you want to delete this translation?');">Delete</a>
                                        <a href="assign_translation.php?id=<?php echo htmlspecialchars($translation['id']); ?>">Assign to Reviewer</a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                                <tr>
